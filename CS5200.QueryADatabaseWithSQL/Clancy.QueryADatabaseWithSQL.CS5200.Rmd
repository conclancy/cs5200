...
```{sql questionOne, connection=dbcon}
SELECT DISTINCT
  LastName, 
  City, 
  State, 
...
## Question 2 - Album Title and Track Count
```{sql questionTwo, connection=dbcon}
SELECT 
  Title, 
...
## Question 3 - Tracks per Genre
```{sql questionThree, connection=dbcon}
SELECT 
  g.Name AS genre, 
...
## Question 4 - Average Tenure
```{sql questionFour, connection=dbcon}
SELECT 
...
## Question 5 - Unique Customers from Brazilian States
```{sql questionFive, connection=dbcon}
SELECT 
  State,
...
## Question 6 - Customers who have not made purchases
```{sql questionSix, connection=dbcon}
SELECT DISTINCT
...
## Question 7 - "Symphony" Titled Albums
```{sql questionSeven, connection=dbcon}
SELECT 
...
## Question 8 - Total Time of Track in Hours, by Artist
```{sql questionEight, connection=dbcon}
SELECT 
...
## Question 9 - Playlist in Descending Order by Total Time
```{sql questionNine, connection=dbcon}
SELECT 
...
## Question 10 - Artist with Tracks of 3 or More Genres.
```{sql questionTen, connection=dbcon}
SELECT 
  ar.Name AS artist_name, 
