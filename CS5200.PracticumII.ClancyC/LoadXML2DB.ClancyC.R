...
#' Date: Spring 2023 
#' 
#' This file contains the logic to load data from the pubmed22n0001-tf.xml file
#' (http://cclancy-cs5200.s3.us-east-2.amazonaws.com/pubmed22n0001-tf.xml) in an
#' AWS S3 bucket into a local SQLite database called `publications.db` located
#' in the current working directory. 
#' 
#' The Entity Relationship Diagram (ERD) can be viewed on Lucid Chart at 
#' https://lucid.app/lucidchart/c7d2a9fe-cb99-48cf-a2d4-145c40fa0c49/edit?viewport_loc=-452%2C21%2C2219%2C1065%2COKcPxCMOTL7Q&invitationId=inv_a5cab192-a5b7-4cdc-bfe6-2a7d25dcee52
#' 
#'
...
# Parse and validate XML file from AWS S3
xmlDOM <- xmlParse(
